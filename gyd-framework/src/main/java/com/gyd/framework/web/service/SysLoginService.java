package com.gyd.framework.web.service;

import javax.annotation.Resource;

import com.gyd.common.utils.*;
import com.gyd.framework.manager.AsyncManager;
import com.gyd.framework.manager.factory.AsyncFactory;
import com.gyd.framework.security.context.AuthenticationContextHolder;
...
import com.gyd.common.exception.user.BlackListException;
import com.gyd.common.exception.user.CaptchaException;
import com.gyd.common.exception.user.CaptchaExpireException;
...
public class SysLoginService
{
    ...
    public String login(String username, String password, String code, String uuid)
    {
        ...
        WebFrameworkUtils.setLoginUserName(ServletUtils.getRequest(), loginUser.getUsername());
        //记录登录信息
