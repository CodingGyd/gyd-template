...
import com.gyd.common.annotation.ApiResource;
import com.gyd.common.utils.ServletUtils;
import com.gyd.framework.security.context.PermissionContextHolder;
...
/**
 * gyd首创 自定义权限实现，ss取自SpringSecurity首字母
 * 
 * @author gyd
 */
@Service("ss")
public class PermissionService
{
    ...
    public boolean resourceAuth() {
        ...
        try {
            ...
            log.error("resourceAuth error",e);
        }
