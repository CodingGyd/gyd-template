...
import com.gydblog.admin.mapper.SysMenuMapper;
import com.gydblog.admin.mapper.SysRoleMapper;
import com.gydblog.admin.mapper.SysRoleMenuMapper;
...
import com.gydblog.common.utils.MetaVo;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public boolean hasChildByMenuId(Long menuId) {
        Long result = menuMapper.selectCount(
                new LambdaQueryWrapperX<SysMenu>().eq(SysMenu::getParentId, menuId));
