    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <span slot="label">
            生成包路径
            <el-tooltip content="生成在哪个java包下，例如 com.gydblog.system" placement="top">
      ...
      <el-col :span="12" v-if="info.genWay == '1'">
        <el-form-item prop="genPath">
          ...
          <el-input v-model="info.genPath" placeholder="填写项目路径，如D://gyd-boot"/>
        </el-form-item>
      </el-col>
    ...
    <el-row v-show="info.tplCategory == 'tree'">
      ...
      <el-col :span="12">
        <el-form-item>
          <span slot="label">
            树编号字段
            <el-tooltip content="树显示的编号字段名,字段类型建议为Integer， 如：id" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
      ...
      <el-col :span="12">
        <el-form-item>
          <span slot="label">
            树父编号字段
            <el-tooltip content="树显示的父编号字段名,字段类型建议为Integer， 如：parent_Id" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
