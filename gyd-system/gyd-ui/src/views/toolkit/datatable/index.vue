    ...
    methods: {
      ...
      handleGen(row) {
        ...
        if (row.genWay == '1') {
          ...
          downLoadZip("/toolkit/datatable/batchGenCode/" + tables, "gydblog");
        }
      }
    }
  };
